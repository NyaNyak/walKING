...
public class PutRanking {
    ...
    public HashMap<String, String> putRanking(String id){
        HashMap<String, String> result;
        RankingThread th = new RankingThread(id);
        th.start();
    ...
    private static class RankingThread extends Thread{
        String id;
        String Url = SERVER + "/ranking";
        HashMap<String, String> result;
        OkHttpClient client = new OkHttpClient();

        public RankingThread(String id){
            this.id = id;
        }
